...
def test(data,
         ...
         plots=False,
         log_imgs=0,
         eval_data='instances_val2017.json'):  # number of logged images
    ...
    # Configure
    model.eval()
    is_coco = 'coco' in data  # is COCO dataset
    with open(data) as f:
    ...
    if save_json and len(jdict):
        ...
        anno_json = glob.glob('../datasets/coco/annotations/' + eval_data)[0]  # annotations json
